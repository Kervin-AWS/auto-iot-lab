...
thingShadows.register(deviceName, {}, function(err, failedTopics) {
    if (isUndefined(err) && isUndefined(failedTopics)) {
        ...
        initialGetClientToken = thingShadows.get(deviceName);
    }
});

// On delta generated by IoT
thingShadows.on('delta', function(deviceName, stateObject) {
    ...
    thingShadows.update(deviceName, { state: { reported: stateObject.state, desired: null } } );
});
...
thingShadows.on('status', function(deviceName, statusType, clientToken, stateObject) {
    ...
    if (initialGetClientToken === clientToken && statusType === 'accepted') {
        ...
        // Else if there is a delta state, resolve it
            ...
            // Report to the Shadow the new state
            thingShadows.update(deviceName, { state: { reported: stateObject.state.delta, desired: null } } );
...
function setDefaultState() {
    ...
    thingShadows.update(deviceName, initialState);
